...
устройства), решает по словарю и символьным триграммам, нужна ли
раскладка сменилась, переключает её через IBus или собственное расширение
GNOME Shell и перепечатывает слово через виртуальную клавиатуру (`uinput`).
